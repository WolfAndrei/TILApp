...
//  
//
//  Created by Andrei Volkau on 22.06.2021.
//
...
struct WebsiteController: RouteCollection {
    ...
    //MARK: - Confirming RouteCollection
    ...
    func createAcronymPostHandler(_ req: Request) throws -> EventLoopFuture<Response> {
        let data = try req.content.decode(CreateAcronymFromData.self)
...
struct CreateAcronymFromData: Content {
    let userID: UUID
    let short: String
    let long: String
